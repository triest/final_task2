...
@section('content')
    ...
    <br>
        ...
        <b>Изменить город: </b>  <input type="checkbox" id="change" name="change"  onchange="document.getElementById(['country']).disabled = !this.checked;document.getElementById(['region']).disabled = !this.checked;document.getElementById(['city']).disabled = !this.checked;" >
        <br>
        <br>
        <label>Страна:
        ...
        <label>Регион:
            <select style="width: 200px" class="region" name="region" class="form-control input-sm" id="region" disabled>
